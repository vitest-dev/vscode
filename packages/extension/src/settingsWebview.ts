...
<!DOCTYPE html>
  ...
  <body>
    <div class="list">
      <div>
        <label title="Show the browser when running tests in the Browser Mode. This will disable parallel execution.">
          <input type="checkbox" data-setting="previewBrowser" />
          Show browser
        </label>
      </div>
    </div>
